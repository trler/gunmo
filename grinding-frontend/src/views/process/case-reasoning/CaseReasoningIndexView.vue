<template>
  <div class="case-reasoning-view">
    ...
    <div class="module-grid">
      ...
      <div class="module-card" @click="navigateToWeightMatrix">
        <div class="module-icon">
          <i class="fas fa-balance-scale"></i>
        </div>
        <div class="module-content">
          <h3 class="module-title">权重设置与判断矩阵</h3>
          <p class="module-description">基于层次分析法的特征权重配置，支持一致性检验</p>
          <div class="module-stats">
            <span class="stat-item">
      ...
      <div class="module-card" @click="navigateToWeightCalculation">
        <div class="module-icon">
          <i class="fas fa-calculator"></i>
        </div>
        <div class="module-content">
          <h3 class="module-title">计算特征权重</h3>
          <p class="module-description">基于层次分析法计算案例特征权重配置</p>
          <div class="module-stats">
            <span class="stat-item">
              <i class="fas fa-balance-scale"></i>
              支持: AHP层次分析法
      ...
      <div class="module-card" @click="navigateToMatchingResult">
        <div class="module-icon">
          <i class="fas fa-search-plus"></i>
        </div>
        <div class="module-content">
          <h3 class="module-title">案例推理结果</h3>
          <p class="module-description">基于权重配置的智能案例推理与优选结果</p>
          <div class="module-stats">
            <span class="stat-item">
...
const navigateToFeatureEntry = () => {
  ElMessage.success('进入案例特征录入模块')
  // 跳转到案例特征录入页面
  window.location.href = '/process/case-reasoning/feature-entry'
}

const navigateToWeightMatrix = () => {
  ElMessage.success('进入权重设置与判断矩阵模块')
  // 跳转到权重矩阵页面
  window.location.href = '/process/case-reasoning/weight-matrix'
}

const navigateToWeightCalculation = () => {
  ElMessage.success('进入计算特征权重模块')
  // 跳转到权重计算页面
  window.location.href = '/process/case-reasoning/weight-calculation'
}

const navigateToMatchingResult = () => {
  ElMessage.success('进入案例推理结果模块')
  // 跳转到案例推理结果页面
  window.location.href = '/process/case-reasoning/reasoning-result'
}
